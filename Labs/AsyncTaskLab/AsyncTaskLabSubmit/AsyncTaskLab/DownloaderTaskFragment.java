...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Integer[] resIdArray = new Integer[MainActivity.sRawTextFeedIds.size()];
		MainActivity.sRawTextFeedIds.toArray(resIdArray);

		// Start the DownloaderTask 
		dt.execute(resIdArray);
	}
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		...
		@Override
		protected String[] doInBackground(Integer... resourceId) {
			return downloadTweets(resourceId);
		}
		...
		private String[] downloadTweets(Integer resourceIDS[]) {
			...
			try {
				for (int idx = 0; idx < resourceIDS.length; idx++) {
					...
					// Log.i(TAG, "" + idx + ": " + feeds[idx].toString());
